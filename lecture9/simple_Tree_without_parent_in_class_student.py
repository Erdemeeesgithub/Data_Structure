...
def PreOrderTraversal(tree):
    ...
    return [str(tree._element)] + PreOrderTraversal(tree._left) + PreOrderTraversal(tree._right)
...
def PostOrderTraversal(tree):
    ...
    if tree == None: 
        return []
    # TODO (use recursion to traverse and return node visit ordering)
    return PostOrderTraversal(tree._left) + PostOrderTraversal(tree._right) + [str(tree._element)]
...
def InOrderTraversal(tree):
    ...
    if tree == None: 
        return []
    # TODO (use recursion to traverse and return node visit ordering)
    return InOrderTraversal(tree._left) + [str(tree._element)] + InOrderTraversal(tree._right)
...
if __name__ == '__main__':
    ...
    ## TODO:
    n3   = TreeWithoutParent('3')
    n2a  = TreeWithoutParent('2')
    n5   = TreeWithoutParent('5')
    n2b  = TreeWithoutParent('2')
    mul  = TreeWithoutParent('*', n3, n2a)
    sub  = TreeWithoutParent('-', n5, n2b)
    tree = TreeWithoutParent('+', mul, sub)
